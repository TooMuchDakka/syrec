        ...
        for (const auto& [key, value] : loadedOptimizationOptions) {
            switch (key) {
                ...
                case NoAdditionalLineSynthesisNewSignalIdentsPrefix: {
                    wereNoAdditionalLineSynthesisConfigOperationsDefined = true;
                    ASSERT_TRUE(!value.rfind("__")) << "Signal ident prefix for new signal generated by no additional line synthesis of assignments must start with two underscore characters, provided value was: " << value;
