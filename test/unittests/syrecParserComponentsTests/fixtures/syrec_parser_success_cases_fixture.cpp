...
INSTANTIATE_TEST_SUITE_P(SyrecParserSuccessCases,
                        ...
                        std::make_pair("production_binaryExpression", "lhsOperandDoesNotSimplifyToConstant"),
                        std::make_pair("production_binaryExpression", "rhsOperandDoesNotSimplifyToConstant"),
                        std::make_pair("production_binaryExpression", "bothOperandDoNotSimplifyToConstant"),
                        std::make_pair("production_binaryExpression", "addOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "subOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "xorOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "multiplyOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "divideOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "moduloOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "upperbitsMultiplicationOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "logicalAndOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "logicalOrOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "bitwiseAndOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "bitwiseOrOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "lessThanOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "greaterThanOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "equalOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "notEqualOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "lessOrEqualThanOperationResultNoSimplified"),
                        std::make_pair("production_binaryExpression", "greatherThanOperationResultNoSimplified"),

                        /* UnaryExpression production */
                        std::make_pair("production_shiftExpression", "logicalNegationOfNumber"),
                        std::make_pair("production_shiftExpression", "logicalNegationOfSignal"),
                        std::make_pair("production_shiftExpression", "logicalNegationOfBinaryExpressionSimple"),
                        std::make_pair("production_shiftExpression", "logicalNegationOfBinaryExpressionComplex"),
                        std::make_pair("production_shiftExpression", "logicalNegationOfUnaryExpression"),
                        std::make_pair("production_shiftExpression", "logicalNegationOfShiftExpression"),

                        std::make_pair("production_shiftExpression", "bitwiseNegationOfNumber"),
                        std::make_pair("production_shiftExpression", "bitwiseNegationOfSignal"),
                        std::make_pair("production_shiftExpression", "bitwiseNegationOfBinaryExpressionSimple"),
                        std::make_pair("production_shiftExpression", "bitwiseNegationOfBinaryExpressionComplex"),
                        std::make_pair("production_shiftExpression", "bitwiseNegationOfUnaryExpression"),
                        std::make_pair("production_shiftExpression", "bitwiseNegationOfShiftExpression"),

                        /* ShiftExpression production */
                        std::make_pair("production_shiftExpression", "leftShiftByConstant"),
                        std::make_pair("production_shiftExpression", "leftShiftBySignalWidth"),
                        std::make_pair("production_shiftExpression", "leftShiftByLoopVariable"),
                        std::make_pair("production_shiftExpression", "leftShiftBySimpleNumberExpression"),
                        std::make_pair("production_shiftExpression", "leftShiftByComplexNumberExpression"),

                        std::make_pair("production_shiftExpression", "rightShiftByConstant"),
                        std::make_pair("production_shiftExpression", "rightShiftBySignalWidth"),
