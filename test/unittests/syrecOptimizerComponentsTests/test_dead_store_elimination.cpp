...
protected:
    ...
    syrec::ReadProgramSettings getDefaultParserConfig() override {
        ...
        return syrec::ReadProgramSettings(defaultSignalBitwidth, true, true, false, false, false, true, optimizations::MultiplicationSimplificationMethod::None, std::nullopt);
    }
};
