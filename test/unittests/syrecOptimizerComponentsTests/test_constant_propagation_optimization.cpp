...
class ConstantPropagationTests: public testing::TestWithParam<std::string> {
public:
...
protected:
    ...
    explicit ConstantPropagationTests():
        astDumper(syrecAstDumpUtils::SyrecASTDumper(true)), config(16, false, false, true) {}
