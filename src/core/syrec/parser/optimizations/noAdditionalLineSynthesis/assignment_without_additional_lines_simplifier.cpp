 ...
 * TODO: During backtracking the active assignments are not removed - FIXED
...
syrec::AssignStatement::vec noAdditionalLineSynthesis::AssignmentWithoutAdditionalLineSimplifier::performSimplificationOfAssignmentRhs(const syrec::AssignStatement::ptr& assignment) const {
